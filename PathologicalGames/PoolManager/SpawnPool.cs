...
namespace PathologicalGames
{
    ...
    public sealed class SpawnPool : MonoBehaviour, IList<Transform>
    {
        ...
        public static Vector3 PoolInitPosition = new Vector3(0, -100, 0);
        ...
        {
            return this.Spawn(prefab, PoolInitPosition, Quaternion.identity);
        }
    ...
    public class PrefabsDict : IDictionary<string, Transform>
    {
        ...
        {
			// todo bug in here 多线程重复添加还是会有问题。这个pool的问题。q5 fanki
